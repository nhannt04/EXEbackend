...
import vn.histra.model.*;
import vn.histra.repository.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userCount == 0) {
            ...
            log.info("[DataInitializer] Đã nạp thành công 2 tài khoản mẫu (traveler@histra.vn, admin@histra.vn).");
